...
class WeightDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'admin.weights.action.actions')
            ->editColumn('created_at', function(Weight $Weight) {
              return $Weight->created_at->toFormattedDateString() ;
            })
            ->editColumn('updated_at', function(Weight $Weight) {
              return $Weight->updated_at->toFormattedDateString() ;
            })
            ->rawColumns([
              'action',
              'checkbox',
