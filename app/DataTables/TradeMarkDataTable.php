...
class TradeMarkDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'admin.trademarks.action.actions')
            ->editColumn('created_at', function(TradeMark $trade) {
              return $trade->created_at->toFormattedDateString() ;
            })
            ->editColumn('updated_at', function(TradeMark $trade) {
              return $trade->updated_at->toFormattedDateString() ;
            })
            ->rawColumns([
              'action',
              'checkbox',
    ...
    protected function getColumns()
    {
        return [
          Column::make('id'),
          Column::make('trade_name_ar'),
          Column::make('trade_name_en'),
