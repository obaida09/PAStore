...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label class="form-label"/>' ).append( str ) );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 *    } );
				 */
				"sNext": "<div  style='width: 8px;padding: 4px 0;'><i class='fas fa-angle-right'></i></div>",
				 ...
				 *    } );
				 */
				"sPrevious": '<div style="width: 8px;padding: 4px 0;"><i class="fas fa-angle-left"></i></div>'
			},
	...
	$.extend( DataTable.ext.classes, {
		...
		/* Filtering */
		"sFilterInput": "form-control search-table",
