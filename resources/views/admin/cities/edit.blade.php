            ...
            <div class="card my-6">
              ...
              <div class="input-group input-group-static">
                <input class="form-control datepicker" placeholder="Please select date" type="text" onfocus="focused(this)" onfocusout="defocused(this)">
                  ...
                  <div class="input-group is-filled input-group-dynamic mb-5 my-4">
                  ...
                  <div class="input-group is-filled input-group-dynamic mb-5">
                  ...
                  <div class="input-group input-group-static mb-5">
                    ...
                    <select class="form-control" name="country_id" id="exampleFormControlSelect1">
                      @foreach ($country as $item)
                        <option value="{{$item->id}}"  @if ($item->id == $city->country_id) selected @endif>{{$item->country_name_en}}</option>
                      @endforeach
                    </select>
