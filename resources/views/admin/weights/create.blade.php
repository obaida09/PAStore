    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-normal" id="exampleModalLongTitle">Create Weight</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="weightCreate" data-route="{{ route('weight.store') }}">
...
<script>
   ...
   // Store City
   $("#reset").click(function() { $("#weightCreate").trigger("reset") })
   $("#weightCreate").submit(function(e) {
    e.preventDefault();
